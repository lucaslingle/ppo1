...
and taking a single step, PPO takes inspiration from an approximate natural policy gradient algorithm known as TRPO, and takes multiple steps using the same collected experience. 
