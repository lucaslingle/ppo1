...
There are many differences between ppo1 and ppo2 [[3]](https://openreview.net/forum?id=r1etN1rtPB), and these differences are not accounted for [[4]](https://github.com/openai/baselines/issues/485#issuecomment-413722708) in the explanation of why ppo2 was released; they appear orthogonal to these reasons, and furthermore our experiments suggest that ppo2's inferior performance can be directly attributed to these differences. 
