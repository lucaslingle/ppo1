...
For anyone seeking to reproduce the results of the PPO paper--or to obtain a simple and effective deep reinforcement learning algorithm more generally--the ppo1 variant is the obvious choice. 
