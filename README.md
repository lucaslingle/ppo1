...
There are many differences between ppo1 and ppo2 [[3]](https://openreview.net/forum?id=r1etN1rtPB), and these differences are not accounted for in the explanation of why ppo2 was released [[4]](https://github.com/openai/baselines/issues/485#issuecomment-413722708). Our experiments suggest that ppo2's inferior performance can be directly attributed to these differences.
